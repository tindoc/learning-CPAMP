...
/********************************************************
   read_cards: Read the cards into the num_in_rank
               and num_in_suit;
...
/********************************************************
   analyze_hand: Determines whether the hand contains a
                 straights, a flush, four-of-a-kind,
